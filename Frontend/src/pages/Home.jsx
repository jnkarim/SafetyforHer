  ...
  return (
    <div style={{ fontFamily: "'Syne', sans-serif", background: '#05030d', color: '#f5f0ff', overflowX: 'hidden' }}>
      <style>{`
        ...
        :root {
          --rose: #ff3d6e; --violet: #8b5cf6; --cream: #fef9f0;
          --dark: #05030d; --mid: #0f0b1e; --card: #100d20;
        }
          ...
          <div className="hero-grid" style={{ display:'grid', gridTemplateColumns:'repeat(auto-fit, minmax(320px, 1fr))', gap:60, alignItems:'center' }}>
            ...
            <div>
              ...
              <div className="fade-up d3" style={{ display:'flex', flexWrap:'wrap', gap:12, marginBottom:48 }}>
                <a href="#" style={{ display:'inline-flex', alignItems:'center', gap:8, padding:'14px 28px', borderRadius:16, background:'linear-gradient(135deg,#ff3d6e,#8b5cf6)', color:'#fff', fontWeight:800, fontSize:13, textDecoration:'none', letterSpacing:'0.02em', boxShadow:'0 0 40px rgba(255,61,110,0.3)' }}>
            ...
            {[...Array(2)].map((_,i) => (
              <span key={i} style={{ display:'inline-flex', gap:0 }}>
                {['TFGBV IS VIOLENCE','66% OF WOMEN EXPERIENCE CYBER HARASSMENT','96% OF DEEPFAKES ARE NONCONSENSUAL','YOU ARE NOT ALONE','REPORT. DOCUMENT. PROTECT.','24/7 AI SUPPORT AVAILABLE','KNOW YOUR RIGHTS IN BANGLADESH'].map((t,j) => (
                  <span key={j} style={{ fontSize:11, fontWeight:800, letterSpacing:'0.2em', color:'rgba(255,255,255,0.9)', paddingRight:60, whiteSpace:'nowrap' }}>◆ {t}</span>
                ))}
              </span>
            ))}
          </div>
        ...
        <div style={{ maxWidth:1100, margin:'0 auto' }}>
          <div style={{ display:'flex', justifyContent:'space-between', alignItems:'flex-end', flexWrap:'wrap', gap:16, marginBottom:52 }}>
            <div>
              ...
              <h2 className="serif" style={{ fontSize:'clamp(2rem,5vw,3.5rem)', fontWeight:900, lineHeight:0.95, letterSpacing:'-0.02em', fontStyle:'italic' }}>Your AI Guardian.</h2>
            </div>
        ...
        <div style={{ maxWidth:1100, margin:'0 auto', position:'relative', zIndex:2 }}>
          <div className="two-col" style={{ display:'grid', gridTemplateColumns:'repeat(auto-fit, minmax(320px, 1fr))', gap:60, alignItems:'center' }}>
            <div>
              ...
              <h2 className="serif" style={{ fontSize:'clamp(2rem,5vw,3.5rem)', fontWeight:900, lineHeight:0.95, letterSpacing:'-0.02em', marginBottom:28, fontStyle:'italic' }}>Scenario Arena.</h2>
            ...
            <div style={{ position:'relative' }}>
              <div style={{ borderRadius:32, padding:28, background:'#100d20', border:'1px solid rgba(255,255,255,0.07)', position:'relative', overflow:'hidden' }}>
                ...
                <div style={{ display:'flex', flexDirection:'column', gap:8 }}>
                  {['Report to Discord Trust & Safety immediately','Confront the person directly in the server','Document everything and contact a legal expert'].map((opt,i) => (
            ...
            <div className="legal-timeline" style={{ display:'grid', gridTemplateColumns:'repeat(6, 1fr)', gap:0, position:'relative', zIndex:2 }}>
              {[
                ...
                <div key={i} className="legal-timeline-item" style={{ display:'flex', flexDirection:'column', alignItems:'center', gap:12 }}>
                  <div className="legal-dot" style={{ width:20, height:20, borderRadius:'50%', background:law.color, border:'3px solid #fef9f0', flexShrink:0 }} />
